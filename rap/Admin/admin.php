            ...
            <nav id="sidebar">
                ...
                <div class="sidebar_blog_2">
                    ...
                    <ul class="list-unstyled components">
                        ...
                        <li><a href="widgets.html"><i class="fa fa-clock-o orange_color"></i> <span>Services</span></a>
                        </li>
                        <li>
                            <a href="#element" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i
                                    class="fa fa-diamond purple_color"></i> <span>Inquiry</span></a>
                        ...
                        <li><a href="tables.html"><i class="fa fa-table purple_color2"></i> <span>Massages</span></a>
                        </li>
                        <!-- <li>
                     ...
                     <li>
                        ...
                        <li><a href="charts.html"><i class="fa fa-bar-chart-o green_color"></i> <span>Report</span></a>
                        </li>
                ...
                <div class="topbar">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <div class="full">
                            ...
                            <div class="logo_section">
                                <a href="index.html"><img class="img-responsive" src="images\logo\logomain.png"
                                        alt="#" /></a>
                            </div>
                                    ...
                                    <ul class="user_profile_dd">
                                        <li>
                                            <a class="dropdown-toggle" data-toggle="dropdown"><img
                                                    ...
                                                    class="name_user">John Mark</span></a>
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="profile.html">My Profile</a>
                                                <a class="dropdown-item" href="settings.html">Settings</a>
                                                <a class="dropdown-item" href="help.html">Help</a>
                                                <a class="dropdown-item" href="index.php"><span>Log Out</span> <i
